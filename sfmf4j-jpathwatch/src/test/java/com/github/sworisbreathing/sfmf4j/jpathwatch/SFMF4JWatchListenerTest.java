...
public class SFMF4JWatchListenerTest {
    ...
    public void testOnCreateEvent() {
        ...
        instance.onEvent(new PathWatchEvent(StandardWatchEventKind.ENTRY_CREATE, path, 1));
    ...
    public void testOnModifyEvent() {
        ...
        SFMF4JWatchListener instance = new SFMF4JWatchListener(listener);
        instance.onEvent(new PathWatchEvent(StandardWatchEventKind.ENTRY_MODIFY, path, 1));
        assertEquals(1, files.size());
        assertEquals(path, Paths.get(files.get(0).getPath()));
    }
    ...
    public void testOnDeleteEvent() {
        ...
        SFMF4JWatchListener instance = new SFMF4JWatchListener(listener);
        instance.onEvent(new PathWatchEvent(StandardWatchEventKind.ENTRY_DELETE, path, 1));
        assertEquals(1, files.size());
        assertEquals(path, Paths.get(files.get(0).getPath()));
    }
